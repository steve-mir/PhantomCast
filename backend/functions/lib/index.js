...
const DLC_SIGNING_PRIVATE_KEY = (0, params_1.defineSecret)("DLC_SIGNING_PRIVATE_KEY"); // RS256 PEM
...
function signClaims(payload) {
    ...
    const token = jwt.sign({ ...payload, iat, exp }, DLC_SIGNING_PRIVATE_KEY.value(), { algorithm: "RS256", header: { alg: "RS256", kid } });
    return { token, exp };
}
...
// ---------- v1_activate ----------
exports.v1_activate = (0, https_1.onRequest)({ region: "us-central1", cors: false, secrets: [DLC_SIGNING_PRIVATE_KEY] }, async (req, res) => {
    if (req.method !== "POST") {
...
// ---------- v1_heartbeat ----------
exports.v1_heartbeat = (0, https_1.onRequest)({ region: "us-central1", secrets: [DLC_SIGNING_PRIVATE_KEY] }, async (req, res) => {
    if (req.method !== "POST") {
        res.status(405).json({ error: "method" });
        return;
    }
