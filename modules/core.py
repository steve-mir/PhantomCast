...
def parse_args() -> None:
    ...
    program.add_argument('--frame-processor', help='pipeline of frame processors', dest='frame_processor', default=['face_swapper_hyperswap'], choices=['face_swapper', 'face_swapper_hyperswap', 'face_enhancer', 'face_enhancer_gpen256', 'face_enhancer_gpen512'], nargs='+')
    ...
    # Face swapper model selection (mutually exclusive: inswapper vs hyperswap).
    modules.globals.fp_ui['face_swapper'] = 'face_swapper' in args.frame_processor
    modules.globals.fp_ui['face_swapper_hyperswap'] = 'face_swapper_hyperswap' in args.frame_processor
    if modules.globals.fp_ui['face_swapper_hyperswap']:
